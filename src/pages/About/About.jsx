  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center w-full min-h-[90vh] text-gray-200">
        ...
        <h1 className="text-5xl uppercase my-3 font-semibold bg-gradient-to-r from-teal-500 to-teal-300 bg-clip-text text-transparent font-madimi">
          {about.title}
        </h1>
        ...
        <div className="flex my-5">
          <button className="py-2 px-4 bg-gradient-to-b from-teal-700 to-teal-500 rounded-full border border-teal-300 hover:from-black/10 transition-all shadow-lg mx-5 ">
            <Link
              to={about.cv}
              target="_blank"
              className="md:text-lg"
              download="Abdullah Siddiqui's Resume.pdf"
            >
              Download CV
            </Link>
          </button>

          <button className="py-2 px-6 rounded-full border border-teal-300 hover:bg-gradient-to-b from-teal-700 to-teal-500 transition-all uppercase shadow-lg">
        ...
        <div className="flex gap-5 my-5">
          <div className="w-[40px] h-[40px] border rounded-full flex justify-center hover:bg-teal-700 items-center ">
            <Link to={about.linkedin} target="_blank">
          ...
          <div className="w-[40px] h-[40px] border rounded-full flex justify-center hover:bg-teal-700 items-center">
            <Link to={about.gitHub} target="_blank">
